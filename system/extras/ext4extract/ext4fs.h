 ...
 **/
/* Declarations for ext4 file system */
...
#define EXT4_DEFAULT_PREALLOC_BLOCKS	8

/* Special Inode Numbers  */
#define EXT4_BAD_INO			1
#define EXT4_ROOT_INO			2
#define EXT4_ACL_IDX_INO		3
#define EXT4_ACL_DATA_INO		4
#define EXT4_BOOT_LOADER_INO	5
#define EXT4_UNDEL_DIR_INO		6

#define EXT4_GOOD_OLD_FIRST_INO	11

#define EXT4_SUPER_MAGIC		0xEF53	/* EXT4 Fs Magic Number */

#define EXT4_LINK_MAX			32000	/* Max count of links to the file */
...
# define EXT4_DESC_PER_BLOCK(s)		(EXT4_BLOCK_SIZE(s) / sizeof (EXT4_GROUP_DESC))
# define EXT4_INODES_PER_GROUP(s)	((s)->s_inodes_per_group)
# define EXT4_INODES_PER_BLOCK(s)	(EXT4_BLOCK_SIZE(s) / sizeof (EXT4_INODE))
...
/* Superblock Flags */
#define EXT4_FEATURE_INCOMPAT_COMPRESSION 0x0001    /* disk/file compression is used */
/*Inode flags  */
...
#define EXT4_BTREE_FL				0x00001000 /* btree format dir */
...
#define EXT4_FL_USER_VISIBLE		0x00001FFF /* User visible flags */
#define EXT4_FL_USER_MODIFIABLE		0x000000FF /* User modifiable flags */
...
#define  EXT4_ACLE_PER_BLOCK(s)		(EXT4_BLOCK_SIZE(s) / sizeof (struct ext4_acl_entry))
#define  EXT4_ADDR_PER_BLOCK(s)		(EXT4_BLOCK_SIZE(s) / sizeof (uint16_t))

#define EXT4_INODE_SIZE(s)	(((s)->s_rev_level == EXT4_GOOD_OLD_REV) ? \
EXT4_GOOD_OLD_INODE_SIZE : (s)->s_inode_size)

#define EXT4_FIRST_INO(s)	(((s)->s_rev_level == EXT4_GOOD_OLD_REV) ? \
EXT4_GOOD_OLD_FIRST_INO :  (s)->s_first_ino)
...
typedef struct tagEXT4_SUPER_BLOCK
{
    ...
    uint16_t	s_magic;			/* a number that identifies the fs (eg. 0xef53 for ext4) */
    ...
    /* for EXT4_DYNAMIC_REV superblocks only */
...
} __attribute__ ((__packed__)) EXT4_SUPER_BLOCK;

/* The Group Descriptors follow the Super Block. */
typedef struct tagEXT4_GROUP_DESC
{
...
}__attribute__ ((__packed__)) EXT4_GROUP_DESC;

/* Structure of an inode on the disk  */
typedef struct tagEXT4_INODE
{
...
} __attribute__ ((__packed__)) EXT4_INODE;

/* EXT4 directory structure */
typedef struct tagEXT4_DIR_ENTRY {
    uint32_t	inode;			/* Inode number */
    uint16_t	rec_len;		/* Directory entry length */
    uint8_t 	name_len;		/* Name length */
    uint8_t	filetype;		/* File type */
    char	name[EXT4_NAME_LEN];	/* File name */
} __attribute__ ((__packed__)) EXT4_DIR_ENTRY;
